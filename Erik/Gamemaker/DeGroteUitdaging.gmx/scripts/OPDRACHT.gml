...
[ 3 punten] - De speler moet kunnen bewegen en schieten.
[ 2 punten] - De speler en vijanden mogen 3x geraakt kunnen worden door kogels.
                Daarna verdwijnen ze. (Levenspunten)
[ 3 punten] - Zodra de speler of alle vijanden in het level gedood zijn, ga je naar het
                "GAME OVER" scherm.
[ 2 punten] - Zodra de speler een vijand aanraakt, is de speler meteen dood.

[ 3 punten] - Je past op een zinvolle manier OVERERVING toe. (Parent/Child)
[ 2 punten] - Je scripts hebben een logische naam en zijn op een nette wijze georganiseerd.

[ 5 punten] - Kogels verdwijnen als ze een speler, een vijand of muren raken. Kogels
                moeten over water kunnen vliegen.
[ 5 punten] - De vijanden schieten één keer om de x-hoeveelheid tijd.
...
[ 5 punten] - Vijanden mogen elkaar niet neer kunnen schieten. De kogels van vijanden mogen
                dus door/over de vijanden heen gaan.

[ 5 punten] - De levens EN punten van de speler moeten altijd zichtbaar zijn. (Interface)
                Per gedoode vijand krijgt de speler een hoeveelheid punten.

[ 5 punten] - De richting waarin de speler en vijanden bewegen moet de richting van hun
                sprite bepalen. (Draw Event - Custom Drawing!)
                (Omhoog bewegen = Omhoog kijken, links bewegen = links kijken, etc...)


[10 punten] - De speler en vijanden mogen niet door muren of over water kunnen bewegen.

[10 punten] - De speler en de vijanden moeten in de richting kunnen schieten waarin zij
                naartoe bewegen/kijken. Als de speler of een vijand schiet, moet de kogel
                vóór de tank gespawned worden. (NIET EROP!)

[10 punten] - Er moet een KLEINE kans bestaan dat vijanden een extra levenspunt op de grond
